...
class Procyon(core.app_scenario.Scenario):
    ...
    def setUp(self):
        # Load actions JSON.
        actions_json = os.path.join(os.path.dirname(__file__), "procyon.json")
    ...
    def kill(self):
        ...
        try:
            self._kill("procyon.exe")
        except:
            pass
        
        try:
            self._kill("Excel.exe Powerpnt.exe Winword.exe")
        except:
            pass
